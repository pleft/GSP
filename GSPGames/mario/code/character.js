...
Mario.Character.prototype.Move = function() {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.ESC)) {
        window.location.replace('../../../index.html');
    }

    var sideWaysSpeed = Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.K) ? 1.2 : 0.6;
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.J) || (this.JumpTime < 0 && !this.OnGround && !this.Sliding)) {
        if (this.JumpTime < 0) {
    ...
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.K) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2) {
    ...
    this.CanShoot = !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.K);
    this.MayJump = (this.OnGround || this.Sliding) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.J);
    ...
    if (this.Carried !== null) {
        ...
        if (!Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.K)) {
...
Mario.Character.prototype.Stomp = function(object) {
    ...
    if (object instanceof Mario.Enemy || object instanceof Mario.BulletBill) {
        ...
        if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.K) && object.Facing === 0) {
            this.Carried = object;
            object.Carried = true;
        } else {
            Enjine.Resources.PlaySound("kick");
