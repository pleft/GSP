...
Mario.Enemy.prototype.Draw = function(context, camera) {
    ...
    if (this.Winged) {
        ...
        if (this.Type !== Mario.Enemy.RedKoopa && this.Type !== Mario.Enemy.GreenKoopa) {
            ...
            context.translate(this.XFlip ? -318 : 0, this.YFlip ? -238 : 0);
            context.drawImage(this.Image, (((this.WingTime / 4) | 0) % 2) * 16, 4 * 32, 16, 32,
                this.XFlip ? (318 - xPixel - 24) : xPixel - 8, this.YFlip ? (238 - yPixel - 32) : yPixel - 8, 16, 32);
            context.restore();
            this.XFlip = !this.XFlip;
        }
    }
    ...
    if (this.Winged) {
        ...
        if (this.Type === Mario.Enemy.RedKoopa && this.Type === Mario.Enemy.GreenKoopa) {
            ...
            context.translate(this.XFlip ? -318 : 0, this.YFlip ? -238 : 0);
            context.drawImage(this.Image, (((this.WingTime / 4) | 0) % 2) * 16, 4 * 32, 16, 32,
                this.XFlip ? (318 - xPixel - 24) : xPixel - 8, this.YFlip ? (238 - yPixel) : yPixel - 8, 16, 32);
            context.restore();
        } else {
            context.save();
            context.scale(this.XFlip ? -1 : 1, this.YFlip ? -1 : 1);
