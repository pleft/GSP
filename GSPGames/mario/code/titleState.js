...
Mario.TitleState.prototype.Enter = function() {
    ...
    var bgLayer0 = new Mario.BackgroundRenderer(bgGenerator.CreateLevel(), 318, 238, 2);
    bgGenerator.SetValues(2048, 15, false, Mario.LevelType.Overground);
    var bgLayer1 = new Mario.BackgroundRenderer(bgGenerator.CreateLevel(), 318, 238, 1);
    ...
    this.font.Strings[0] = { String: "Press A to Start", X: 96, Y: 120 };
...
Mario.TitleState.prototype.CheckForChange = function(context) {
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.J)) {
