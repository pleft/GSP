...
Mario.MapState = function() {
    ...
    this.MapImage.width = 318;
    this.MapImage.height = 238;
...
Mario.MapState.prototype.RenderStatic = function() {
    var x = 0,
        ...
        xx = 0,
        yy = 0,
        image = Enjine.Resources.Images["worldMap"],
        type = 0;
...
Mario.MapState.prototype.Update = function(delta) {
    ...
    if (this.MoveTime > 0) {
        ...
        if (this.CanEnterLevel && Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.J)) {
        ...
        this.CanEnterLevel = !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.J);
